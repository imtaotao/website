...
describe('ModuleCssBuilder', () => {
  ...
  beforeEach(() => {
    fixture = createCssTestFixture('auklet-builder-');
    aukletConfig = {};
  ...
  test('builds package, format and module CSS entries', async () => {
    ...
    writeFile(
      'node_modules/@scope/theme/tokens.css',
      '.token { color: green; }',
    );
  ...
  const setAukletConfig = (config: AukletConfig) => {
    aukletConfig = config;
  };
